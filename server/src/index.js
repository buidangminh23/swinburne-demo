...
const userRoleSchema = z.object({
  role: z.enum(["STUDENT", "LECTURER", "EQUIPMENT_MANAGER", "SERVER_MANAGER", "ADMIN", "EVENT_STAFF"])
});
...
const CAPABILITIES = {
  ...
  EQUIPMENT_MANAGER: ["APPROVE_REQUEST", "DENY_REQUEST", "CONFIRM_RETURN", "SEND_REMINDER", "MANAGE_EQUIPMENT", "MANAGE_REQUEST", "VIEW_ANY_HISTORY"],
  SERVER_MANAGER: ["APPROVE_REQUEST", "DENY_REQUEST", "CONFIRM_RETURN", "SEND_REMINDER", "MANAGE_EQUIPMENT", "MANAGE_REQUEST", "VIEW_ANY_HISTORY"],
